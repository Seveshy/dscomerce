...
public class ProductController {
    ...
    public ResponseEntity<Page<ProductMinDto>> findAllPage(@RequestParam(name = "name", defaultValue = "") String name,
            Pageable pageable) {
        Page<ProductMinDto> prodPage = productService.findAllPage(name, pageable);
